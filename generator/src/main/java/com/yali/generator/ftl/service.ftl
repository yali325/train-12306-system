package com.yali.train.${module}.service;
...
import com.yali.train.${module}.domain.${Domain};
import com.yali.train.${module}.domain.${Domain}Example;
import com.yali.train.${module}.mapper.${Domain}Mapper;
